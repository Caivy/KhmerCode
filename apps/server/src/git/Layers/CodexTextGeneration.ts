...
import { DEFAULT_GIT_TEXT_GENERATION_MODEL } from "@khmercode/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@khmercode/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `khmercode-${prefix}-${process.pid}-${randomUUID()}.tmp`);
