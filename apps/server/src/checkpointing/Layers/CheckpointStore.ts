...
import { CheckpointRef } from "@khmercode/contracts";
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "khmercode-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "KhmerCode",
              GIT_AUTHOR_EMAIL: "khmercode@users.noreply.github.com",
              GIT_COMMITTER_NAME: "KhmerCode",
              GIT_COMMITTER_EMAIL: "khmercode@users.noreply.github.com",
            };
            ...
            const message = `khmercode checkpoint ref=${input.checkpointRef}`;
