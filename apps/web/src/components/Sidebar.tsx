...
function KhmerCodeWordmark() {
  return (
    ...
    >
      <path
        fillRule="evenodd"
        d="M0 0 H13 V16 L52 0 V13 L13 28 V32 L52 47 V60 L13 44 V60 H0 Z M60 0 H110 V60 H60 Z M73 13 H110 V47 H73 Z"
        fill="currentColor"
      />
    </svg>
  );
...
export default function Sidebar() {
  ...
  const shouldShowProjectPathEntry =
    addingProject && !shouldBrowseForProjectImmediately;
  ...
  const wordmark = (
    <div className="flex items-center justify-center gap-2">
      ...
      <Tooltip>
        <TooltipTrigger
          render={
            <div className="flex min-w-0 items-center gap-1 cursor-pointer">
              <KhmerCodeWordmark />
