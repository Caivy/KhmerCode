...
import { type ProviderKind, DEFAULT_GIT_TEXT_GENERATION_MODEL } from "@khmercode/contracts";
import { getModelOptions, normalizeModelSlug } from "@khmercode/shared/model";
import {
  getAppModelOptions,
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="mb-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Choose how KhmerCode looks across the app.
                </p>
              </div>
