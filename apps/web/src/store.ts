...
const PERSISTED_STATE_KEY = "khmercode:renderer-state:v8";
const LEGACY_PERSISTED_STATE_KEYS = [
  "khmercode:renderer-state:v7",
  "khmercode:renderer-state:v6",
  "khmercode:renderer-state:v5",
  "khmercode:renderer-state:v4",
  "khmercode:renderer-state:v3",
