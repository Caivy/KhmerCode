// This file mostly exists because we want dev mode to say "KhmerCode (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = "com.khmercode.khmercode";
...
function installElectronBinary(require) {
  ...
  if (result.status !== 0) {
    throw new Error(
      "Electron is installed but its binary is missing, and automatic recovery failed. Run `pnpm install` from the repo root and retry.",
    );
  }
}
